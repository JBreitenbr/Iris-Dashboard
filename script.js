...
} box.selectAll("circle1").data(data).enter().append("circle").attr("cx",(item)=>xScale1(item.rand1)+w/16).attr("cy",(item) => yScale1(item.sepal_length)).attr("r",Math.min(w,h)/150).attr("fill",(item)=>varDict[item.variety]).style("opacity",0.6).style("stroke","grey").style("stroke-width",1);
box.selectAll("circle2").data(data).enter().append("circle").attr("cx",(item)=>xScale1(item.rand2)+0.8*w/4+w/16).attr("cy",(item) => yScale1(item.sepal_width)).attr("r",Math.min(w,h)/150).attr("fill",(item)=>varDict[item.variety]).style("opacity",0.6).style("stroke","grey").style("stroke-width",1);
      box.selectAll("circle3").data(data).enter().append("circle").attr("cx",(item)=>xScale1(item.rand3)+1.6*w/4+w/16).attr("cy",(item) => yScale1(item.petal_length)).attr("r",Math.min(w,h)/150).attr("fill",(item)=>varDict[item.variety]).style("opacity",0.6).style("stroke","grey").style("stroke-width",1);
box.selectAll("circle4").data(data).enter().append("circle").attr("cx",(item)=>xScale1(item.rand4)+2.4*w/4+w/16).attr("cy",(item) => yScale1(item.petal_width)).attr("r",Math.min(w,h)/150).attr("fill",(item)=>varDict[item.variety]).style("opacity",0.6).style("stroke","grey").style("stroke-width",1);

scatter1.selectAll("circle5").data(data).enter().append("circle").attr("cx",(item)=>(xScale2(item.sepal_width))).attr("cy",(item) => yScale2(item.sepal_length)).attr("r",Math.min(w,h)/75).attr("fill",(item)=>varDict[item.variety]).style("opacity",0.6).style( "stroke","grey").style("stroke-width",1);
...
scatter2.selectAll("circle6").data(data).enter().append("circle").attr( "cx",(item)=>(xScale3(item.petal_width))).attr("cy",(item) => yScale3(item.petal_length)).attr("r",Math.min(w,h)/75).attr("fill",(item)=>varDict[item.variety]).style("opacity",0.6).style("stroke","grey").style("stroke-width",1);
